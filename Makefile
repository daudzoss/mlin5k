all : mlinkb_40col.prg mlinkb_80col.prg mlinkb_vic20.prg mlinkb_c64.prg mlinkb_p500.prg mlinkb_c16.prg mlinkb_c128.prg
...
mlinkb_80col.prg : main.asm checksub.asm drawsubs.asm movesubs.asm pet/80col.inc
	64tass -a -DADDLKEY:=1 pet/80col.inc main.asm -L mlinkb_80col.lst -o mlinkb_80col.prg
...
mlinkb_b128.prg : main.asm checksub.asm drawsubs.asm movesubs.asm b128/header.inc
	64tass -a -DADDLKEY:=1 b128/header.inc main.asm -L mlinkb_b128.lst -o mlinkb_b128.prg
...
mlinkb_c128.prg : main.asm checksub.asm drawsubs.asm movesubs.asm c128/40col.inc
	64tass -a -DADDLKEY:=1 c128/40col.inc main.asm -L mlinkb_c128.lst -o mlinkb_c128.prg
